...
import { useAllApplications, useUpdateApplicationStatus } from "../../hooks/applications/useApplications";
...
const AllApplications = () => {
  ...
  const handleChangeStatus = ()=> mutate(status, {
  ...
  >
    <div className="card-body d-flex flex-column p-3">
      ...
      <div className="mt-auto">
        ...
        <Pagination currentPage={page} totalPages={Math.ceil(totalCount / 10)} onPageChange={setPage} />
      </div>
    </div>
  );
};
